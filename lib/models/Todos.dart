...
class Todos extends amplify_core.Model {
  ...
  const Todos._internal({required this.id, required task, required isDone, createdAt, updatedAt}): _task = task, _isDone = isDone, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Todos copyWithModelFieldValues({
  ...
  static final amplify_core.QueryModelIdentifier<TodosModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<TodosModelIdentifier>();
...
class _TodosModelType extends amplify_core.ModelType<Todos> {
 ...
 */
class TodosModelIdentifier implements amplify_core.ModelIdentifier<Todos> {
  final String id;
